...
import { PresetSelector } from "@/features/social-resizer/components/PresetSelector";
import { CropEditor } from "@/features/social-resizer/components/CropEditor";
import { ExportControls } from "@/features/social-resizer/components/ExportControls";
import { PageTransition } from "@/components/shared/PageTransition";

const UploadZone = dynamic(
  () =>
    import("@/features/social-resizer/components/UploadZone").then((m) => ({
...
export default function SocialMediaResizerPage() {
  const originalFile = useSocialResizerStore((s) => s.originalFile);
  const error = useSocialResizerStore((s) => s.error);
  const reset = useSocialResizerStore((s) => s.reset);
      ...
      <div className="container-page py-10 sm:py-16">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-lg text-text-secondary">
            Resize photos to the exact pixel dimensions for Instagram, YouTube,
            Facebook, X, LinkedIn, Pinterest, and TikTok — all in your browser.
          </p>
        </div>
        ...
        {originalFile && (
          <div className="mx-auto mt-10 max-w-6xl">
            ...
            {/* Three-column layout: presets + preview + export */}
        ...
        {!originalFile && (
          <div className="mx-auto mt-8 max-w-xl text-center">
            <p className="text-sm text-text-muted">
              No uploads. No servers. 100% private browser-based resizing.
            </p>
          </div>
        )}
      </div>
