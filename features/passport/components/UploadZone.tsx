...
export function UploadZone() {
  const setFile = usePassportStore((s) => s.setFile);
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm text-text-secondary">
        or{" "}
        <span className="font-medium text-primary">browse</span> from your device,
      ...
      <p className="mt-4 flex items-center justify-center gap-1.5 text-xs text-text-muted">
        ...
        Best results: a straight-on selfie with your face centered and lit evenly
      </p>
