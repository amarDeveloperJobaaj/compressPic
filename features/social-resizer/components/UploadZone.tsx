...
export function UploadZone() {
  const setFile = useSocialResizerStore((s) => s.setFile);
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-5 text-lg font-semibold text-text-primary">Drop your image here</h3>
      ...
      <p className="mt-4 flex items-center justify-center gap-1.5 text-xs text-text-muted">
        ...
        20+ presets for Instagram, YouTube, Facebook, X, LinkedIn, Pinterest & TikTok
      </p>
