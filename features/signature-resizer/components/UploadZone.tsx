...
/** Upload zone: drag & drop, browse, or paste — everything stays in the browser. */
export function UploadZone() {
  const setFile = useSignatureResizerStore((s) => s.setFile);
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-5 text-lg font-semibold text-text-primary">Drop your signature here</h3>
      ...
      <p className="mt-4 flex items-center justify-center gap-1.5 text-xs text-text-muted">
        ...
        Best results: a signature with a clean background — transparent PNGs are kept transparent
      </p>
